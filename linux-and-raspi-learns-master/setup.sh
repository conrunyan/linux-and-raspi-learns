...
for newDir in {0..100}; do mkdir secretDir_$newDir; done
echo "Copying datasets..."
for sd in ./secretDir_*/; do echo "In dir: ${sd}" && for i in {0..10}; do cp ./cali_crimes.txt ${sd}cali_crimes_$i.txt;done ;done
